...
### ドキュメントエリアの分割機能が動作しない場合がある

通常の`novel`ドキュメントなどを表示時、分割ボタンを押しても分割されない。

### `preview`表示のタブを閉じる事ができない

現在、`preview`表示のタブを閉じる事ができない。
また、プレビューはエディターとセットで表示されるビューです。  
反対サイドのエディターが閉じられると、プレビューも閉じられます。  
